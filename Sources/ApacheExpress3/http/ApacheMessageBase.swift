...
open class ApacheMessageBase : ExExpress.HttpMessageBaseType {
  ...
  public let apacheRequest : http_internal.ApacheRequest
  ...
  open var headers : Dictionary<String, Any> {
  ...
  open func setHeader(_ name: String, _ value: Any) {
  ...
  open func removeHeader(_ name: String) {
    apr_table_unset(_headersTable, name)
  }
  
  open func getHeader(_ name: String) -> Any? {
